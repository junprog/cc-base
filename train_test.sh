...
python train.py --save-dir /mnt/hdd02/res-rgbd --exp exp01-3 --arch csrnet --pool-num 3 --up-scale 1 --rgb --lr 1e-6
#python train.py --save-dir /mnt/hdd02/res-rgbd --exp exp01-4 --arch mcnn --pool-num 2 --up-scale 1 --rgb
python train.py --save-dir /mnt/hdd02/res-rgbd --exp exp01-5 --arch vgg19 --pool-num 3 --up-scale 1 --rgb --lr 1e-6
...
python train.py --save-dir /mnt/hdd02/res-rgbd --exp exp02-5 --arch vgg19 --pool-num 3 --up-scale 1 --depth --lr 1e-6
...
python train.py --save-dir /mnt/hdd02/res-rgbd --exp exp03-5 --arch vgg19 --pool-num 3 --up-scale 1 --depth --rgb --lr 1e-6
